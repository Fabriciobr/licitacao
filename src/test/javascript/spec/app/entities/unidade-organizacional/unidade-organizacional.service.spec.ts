...
describe('Service Tests', () => {
    ...
    describe('UnidadeOrganizacional Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UnidadeOrganizacionalService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/unidade-organizacionals';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UnidadeOrganizacional', () => {
